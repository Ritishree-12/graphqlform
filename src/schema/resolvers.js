...
const Form = () => {
    ...
    const citiesData = [
        ...
        {
            statesName: 'Telengana',
            cities: [
                { label: 'Hyderabad' },
                { label: 'Hitec-citiesName' },
                { label: 'Madhapur' },
                { label: 'Ameerpet' },
                { label: 'Jubliee Hills' },
                { label: 'Secunderbad' },
    ...
    const filteredCities = citiesData.find((data) => data.statesName === selectedState)?.cities || [];
                                ...
                                <div className='row'>
                                    <div className="col-4">
                                        ...
                                        >
                                            ...
                                            {citiesData.map((data) => (
                                                <option key={data.statesName} value={data.statesName}>
                                                    {data.statesName}
                                                </option>
                                            ))}
                                        </select>
                                    ...
                                    <div className="col-4">
                                        ...
                                        >
                                            ...
                                            {filteredCities.map((citiesName) => (
                                                <option key={citiesName.value} value={citiesName.value}>
                                                    {citiesName.label}
                                                </option>
                                            ))}
