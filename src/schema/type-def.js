                            ...
                            <form onSubmit={submitHandler}>
                                ...
                                <div className='row'>
                                    <div className="col-4">
                                        ...
                                        <select
                                            className="form-control"
                                            value={inputValue.state || parseInt("")} // Update from "inputValue.statesName" to "inputValue.state"
                                    ...
                                    <div className="col-4">
                                        ...
                                        <select
                                            className="form-control"
                                            value={inputValue.city || parseInt("")}
                                            onChange={handleCity}
                                        ...
                                        >
                                            ...
                                            {city &&
                                                city.map((citiesData) => (
                                                    <option key={(citiesData.id)} value={(citiesData.id)}>
